...
const NexusBox = () => {
    return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height={65} width={65} viewBox="0 0 200 200">
            ...
            <polygon transform="translate(20, 31)" strokeWidth={2} stroke fill="#7b2cbf" points="80,50 80,75 80,99 40,75" />
            ...
            <polygon transform="rotate(180 100 100) translate(20, 20)" strokeWidth={2} stroke fill="#9d4edd" points="80,50 80,75 80,99 40,75" />
            ...
            <polygon transform="rotate(45 100 100) translate(80, 95)" strokeWidth={2} stroke fill="#e0aaff" points="5,0 5,5 0,5 0,0" id="particles" />
            <polygon transform="rotate(45 100 100) translate(80, 55)" strokeWidth={2} stroke fill="#c77dff" points="6,0 6,6 0,6 0,0" id="particles" />
...
const StyledWrapper = styled.div`
    ...
    @keyframes umbral {
        ...
        50% {
        stop-color: rgba(157, 78, 221, 0.519);
        }
        100% {
        stop-color: #9d4edd2e;
        }
